...
# Load datasets
d1 = xr.open_dataset("/scratch/c7071034/WPS/geo_em.d01.nc")
d2 = xr.open_dataset("/scratch/c7071034/WPS/geo_em.d02.nc")

# Extract variables
var1 = d1["HGT_M"].isel(Time=0)
lat1 = d1["XLAT_M"].isel(Time=0)
lon1 = d1["XLONG_M"].isel(Time=0)

var2 = d2["HGT_M"].isel(Time=0)
lat2 = d2["XLAT_M"].isel(Time=0)
...
# Domain labels
ax.text(
    float(lon2[0, 0]) + 0.4, float(lat2[0, 0]) + 0.2, "d02", fontsize=20, weight="bold"
)
ax.text(
