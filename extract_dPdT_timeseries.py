...
columns = ["dT_calc_mean", "dT_model_mean", "dGPP_calc_mean", "dGPP_model_mean", "dGPP_real_mean", "dRECO_calc_mean", "dRECO_model_mean", "dRECO_real_mean"]
...
for wrf_file in file_list:
    ...
    for wrf_path in wrf_paths[1:]:
        ...
        CLDFRC_coarsegrid = nc_fidcoarsegrid.variables["CLDFRA"][0, :, :, :]
        ...
        proj_dGPPdT_coarsegrid = proj_on_finer_WRF_grid(
            lats_coarsegrid,
            lons_coarsegrid,
            dGPPdT_coarsegrid,
            lats_fine,
        ...
        proj_CLDFRC_coarsegrid = proj_on_finer_WRF_grid_3D(
            lats_coarsegrid,
            lons_coarsegrid,
            CLDFRC_coarsegrid,
            lats_fine,
        ...
        new_landmask = generate_coastal_mask(veg_type, buffer_km=30.0, grid_spacing_km=50.0) # TODO adopt to resolution
